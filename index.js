...
function pastafarfalle() {
  ...
  gsap.to("svg .main-2", {
    duration: 0.6,
    ease: "expo.out",
    scale: 1.2, // Замените морфинг на масштабирование
    opacity: 1,
  });
...
function pastaspaghetti() {
  ...
  gsap.to(".main-1", { duration: 0.6, ease: "expo.out", scale: 1.2 });
  gsap.to(".main-2", { duration: 0.6, ease: "expo.out", scale: 1.2 });
  gsap.to(".main-3", { duration: 0.6, ease: "expo.out", scale: 1.2 });
}
